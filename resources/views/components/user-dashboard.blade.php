<div class="mx-auto w-1/3 flex justify-around p-2 bg-blue-500">
    ...
    @guest
        ...
        <a class="text-center text-xs     bg-green-900 text-white  py-1 px-3 border mb-3 border-white rounded-xl" href="{{route('auth.loginPage')}}">{{__('crud.login')}}</a>
